            ...
            <div className="home">
                ...
                <div class="gallery-container">
                    ...
                    <br/>
                        ...
                        <Link to="/brand/Ferrari" class="gallery">
                            <img src="img/brandLogo/Ferrari.jpg"width="750" height="400" />
                            <div class="desc">Ferrari</div>
                        </Link>
                           <Link to="/brand/Volvo" class="gallery">
                            <img src="img/brandLogo/Volvo.jpg"width="750" height="400" />
                            <div class="desc">Volvo</div>
                        </Link>
                           <Link to="/brand/Jaguar" class="gallery">
                            <img src="img/brandLogo/Jaguar.png"width="750" height="400" />
                            <div class="desc">Jaguar</div>
                        </Link>
                          <Link to="/brand/Mercedes-Benz" class="gallery">
                            <img src="img/brandLogo/Mercedes-Benz.jpg"width="750" height="400" />
                            <div class="desc">Mercedes-Benz</div>
                        </Link>
                           <Link to="/brand/Rolls Royce" class="gallery">
                            <img src="img/brandLogo/Rolls Royce.jpg"width="750" height="400" />
                            <div class="desc">Rolls Royce</div>
                        </Link>
                       <Link to="/brand/Renault" class="gallery">
                            <img src="img/brandLogo/Renault.jpg"width="750" height="400" />
                            <div class="desc">Renault</div>
                        </Link>
